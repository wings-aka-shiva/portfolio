                    ...
                    <div className="flex p-6 gap-4">
                        <div className="box-shadow-black-000000 h-46 w-36 p-4 flex flex-col gap-2 border rounded-3xl bg-[#ffffff] min-w-[144px]">
                            ...
                            <div className="flex flex-grow flex-col justify-between">
                                ...
                                <button onClick={() => { window.open("https://www.iffa.com.au/", '_blank') }} className="transition ease-in-out duration-300 box-shadow-black-000000 bg-[#ffffff] cursor-pointer rounded-xl text-sm border-[1.5px] py-[2px]">visit</button>
                            </div>
                        </div>
                        <div className="">
                    ...
                    <div className="flex p-6 pt-0 gap-4">
                        <div className="box-shadow-black-000000 h-46 w-36 p-4 flex flex-col gap-2 border rounded-3xl bg-[#ffffff] min-w-[144px]">
                            ...
                            <div className="flex flex-grow flex-col justify-between">
                                ...
                                <button onClick={() => { window.open("https://www.keka.com/", '_blank') }} className="transition ease-in-out duration-300 box-shadow-black-000000 bg-[#ffffff] cursor-pointer rounded-xl text-sm border-[1.5px] py-[2px]">visit</button>
                            </div>
                        </div>
                        <div className="">
                            <h1 className="font-semibold">KEKA Technologies <span className="text-xs">
                                Hyderabad - (May 2023 - Dec 2024)</span></h1>
                            <ul className="list-disc pl-6 text-sm">
                                <li>
