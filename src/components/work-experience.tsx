                ...
                <div className="flex flex-col sm:flex-row gap-4 bg-[#d8e7ff] rounded-b-3xl p-4 overflow-auto items-center">
                    ...
                    <div className="box-shadow-black-000000 h-46 w-36 p-4 flex flex-col gap-2 border rounded-3xl bg-[#ffffff] min-w-[144px]">
                        ...
                        <div className="flex flex-grow flex-col justify-between">
                            <h6 className="bg-[#000000] text-[#FFFFFF] text-center">IFFA</h6>
                            <p className="p-2 leading-none text-sm">IT - Developer</p>
                            <button onClick={() => { window.open("https://github.com/wings-aka-shiva", '_blank') }} className="transition ease-in-out duration-300 box-shadow-black-000000 bg-[#ffffff] cursor-pointer rounded-xl text-sm border-[1.5px] py-[2px]">Contributions</button>
                        </div>
                    </div>
                    ...
                    <div className="">
                        <h1 className="font-semibold">International Film Festival of Australia [IFFA] <span className="text-xs">IT - Developer
                            Melbourne - (Mar 2025 - Jun 2025) - Internship</span></h1>
                    ...
                    <div className="">
                        <h1 className="font-semibold">KEKA Technologies <span className="text-xs">Associate Software Engineer
                            Hyderabad - (May 2023 - Dec 2024) - Internship</span></h1>
                        <ul className="list-disc pl-6 text-sm">
                            <li>
